...
const Portal$2 = /*#__PURE__*/React.forwardRef(function Portal(props, ref) {
  const {
    children,
    container,
    disablePortal = false
...
function GlobalStyles(props) {
  ...
  return /*#__PURE__*/jsxRuntime_1(react.Global, {
    styles: globalStyles
  });
}
...
var StyledBreadcrumb = material.styled(material.Breadcrumbs)({
...
var VdsBreadcrumb = function (_a) {
    ...
    return (React__default.createElement(material.ThemeProvider, { theme: theme },
        React__default.createElement(StyledBreadcrumb, null, children)));
};

var VdsDialog = styled$1(material.Dialog)(function (_a) {
...
var VdsTooltip = material.styled(function (_a) {
    var className = _a.className, props = __rest$1(_a, ["className"]);
    return React.createElement(material.Tooltip, __assign$1({}, props, { componentsProps: { tooltip: { className: className } } }));
})({
...
var MiniDrawerListItemWithTooltip = React.forwardRef(function MiniDrawerListItemWithTooltip(props, ref) {
    ...
    return (React.createElement(ListItem, __assign$1({}, other, { button: true, ref: ref, sx: __assign$1(__assign$1({}, checkActiveItem(module, activeItem, level) || itemStyle["level_" + level]), { minHeight: 48 }), onClick: function () {
            onClick && onClick(props);
            setActiveItem(module);
        } }),
        React.createElement(ListItemIcon, null, icon !== null && icon !== void 0 ? icon : React.createElement(BsCircle, { style: { fontSize: 23 } }))));
});
var MiniDrawerListItemWithChildTooltip = React.forwardRef(function MiniDrawerListItemWithChildTooltip(props, ref) {
    ...
    return (React.createElement(ListItem, __assign$1({}, other, { button: true, onClick: function () {
            onClick && onClick(props);
        ...
        React.createElement(ListItemIcon, null, icon !== null && icon !== void 0 ? icon : React.createElement(BsCircle, { style: { fontSize: 23 } })),
        accordionState === id ? React.createElement(iconsMaterial.ExpandLess, null) : React.createElement(iconsMaterial.ExpandMore, null)));
});
var MiniDrawerListItem = function (item) {
    ...
    if (drawerState) {
        return (React.createElement(ListItem, { button: true, onClick: function () {
            ...
            React.createElement(ListItemIcon, null, level !== 3 && (icon !== null && icon !== void 0 ? icon : React.createElement(BsCircle, { style: { fontSize: 23 } }))),
            React.createElement(ListItemText, { primary: title ? title(item) : module })));
    }
    return (React.createElement(VdsTooltip, { arrow: true, title: title ? title(item) : module, placement: "right" },
        React.createElement(MiniDrawerListItemWithTooltip, { activeItem: activeItem, module: module, setActiveItem: setActiveItem, icon: icon, level: level, onClick: onClick })));
};
var MiniDrawerListItemWithChild = function (item) {
    ...
    if (drawerState) {
        return (React.createElement(ListItem, { button: true, onClick: function () {
            ...
            React.createElement(ListItemIcon, null, level !== 3 && (icon !== null && icon !== void 0 ? icon : React.createElement(BsCircle, { style: { fontSize: 23 } }))),
            React.createElement(ListItemText, { primary: title ? title(item) : module }),
            accordionState ? React.createElement(iconsMaterial.ExpandLess, null) : React.createElement(iconsMaterial.ExpandMore, null)));
    }
    return (React.createElement(VdsTooltip, { arrow: true, title: title ? title(item) : module, placement: "right" },
        React.createElement(MiniDrawerListItemWithChildTooltip, { module: module, icon: icon, id: id, level: level, activeItem: activeItem, accordionState: accordionState, handleAccordionClose: handleAccordionClose, onClick: onClick, childrens: childrens })));
};
var MenuNodeChildrensList = function (_a) {
    ...
    var _c = React.useState(true), accordionState = _c[0], setAccordionState = _c[1];
    var handleAccordionClose = function () { setAccordionState(!accordionState); };
    return (React.createElement(React.Fragment, null,
        React.createElement(MiniDrawerListItemWithChild, __assign$1({}, item, { activeItem: activeItem, drawerState: drawerState, handleAccordionClose: handleAccordionClose, accordionState: accordionState })),
        React.createElement(material.Collapse, { in: accordionState, timeout: "auto", unmountOnExit: true },
            React.createElement(List, { component: "div", disablePadding: true }, (_b = item.childrens) === null || _b === void 0 ? void 0 : _b.map(function (item, j) {
                return (React.createElement(MenuNodeList, { menuNodes: [item], drawerState: drawerState, activeItem: activeItem, setActiveItem: setActiveItem, key: "child-" + j }));
            })))));
};
var MenuNodeList = function (_a) {
    ...
    return menuNodes.map(function (item, i) {
        ...
        if (childrens === null || childrens === void 0 ? void 0 : childrens.length) {
            return (React.createElement(MenuNodeChildrensList, { key: "child-" + i, item: item, drawerState: drawerState, activeItem: activeItem, setActiveItem: setActiveItem }));
        }
        return (React.createElement(MiniDrawerListItem, __assign$1({ drawerState: drawerState, activeItem: activeItem, setActiveItem: setActiveItem, key: "item-" + i }, item)));
    });
};
/**
...
var VdsDrawer = function (props) {
    ...
    var _a = React.useState(true), drawerState = _a[0], setDrawerState = _a[1];
    ...
    return (React.createElement("div", { style: { display: "flex", height: '100%' } },
        React.createElement("div", { style: { height: '100%' } },
            React.createElement(Drawer$1, { variant: "permanent", open: drawerState },
                React.createElement(List, { disablePadding: true },
                    React.createElement(ListItem, { style: {
                        ...
                        React.createElement(ListItemIcon, { style: {
                                ...
                                color: "white",
                                cursor: "pointer",
                            }, onClick: drawerState ? handleDrawerClose : handleDrawerOpen }, drawerState ? React.createElement(ChevronLeftIcon, null) : React.createElement(MenuIcon, null)))),
                React.createElement(Divider, { style: { backgroundColor: "white" } }),
                React.createElement(ScrollList, { open: drawerState, disablePadding: true },
                    React.createElement(MenuNodeList, { menuNodes: menuNodes, drawerState: drawerState, activeItem: activeItem, setActiveItem: setActiveItem })))),
...
//#endregion
//#region StyledComponents
var StyledContainer = material.styled('div')({
    display: 'flex',
    alignItems: 'center',
    textAlign: 'center',
...
var StyledBackEventContainer = material.styled('div')({
    padding: '8px'
});
var StyledTitleContainer = material.styled('div')({
    fontSize: '16px',
    color: '#005075',
    lineHeight: "20px",
    letterSpacing: '0',
...
var StyledContentContainer = material.styled('div')({
    display: 'flex',
    justifyContent: 'center',
    fontSize: "12px",
    color: "#5A6872",
...
var StyledPageTitleContainer = material.styled('div')({
    flexGrow: 1,
    display: 'flex',
    flexDirection: 'column'
});
var StyledIconButton = material.styled(material.IconButton)({
    borderRadius: 0
});
//#endregion
var VdsPageTitle = function (props) {
    ...
    return (React.createElement(StyledContainer, null,
        historyBackEvent && (React.createElement(StyledBackEventContainer, null,
            React.createElement(StyledIconButton, { onClick: historyBackEvent },
                React.createElement(BiArrowBack, { style: { color: "#0090D1" } })))),
        React.createElement(StyledPageTitleContainer, null,
            React.createElement(StyledTitleContainer, null, title),
            content && (React.createElement(StyledContentContainer, null, content)))));
};
...
var ContainerWithTooltip = React.forwardRef(function ContainerWithTooltip(_a, ref) {
    var children = _a.children, props = __rest$1(_a, ["children"]);
    //  Spread the props to the underlying DOM element.
    return React.createElement("div", __assign$1({}, props, { ref: ref }), children);
});
var StyledInput = material.styled(material.Input)(function (_a) {
...
function CustomSearch(_a, ref) {
    ...
    var _c = React.useState((_b = initialize === null || initialize === void 0 ? void 0 : initialize.search) !== null && _b !== void 0 ? _b : ''), search = _c[0], setSearch = _c[1];
    ...
    return (React.createElement("div", { style: { display: 'flex', alignItems: 'center' } },
        React.createElement(StyledInput, { onChange: handleSearchChange, placeholder: searchConfig === null || searchConfig === void 0 ? void 0 : searchConfig.placeholder, size: "small", value: search, onKeyPress: function (event) {
                var _search = event.target.value;
                if (event.key === 'Enter') {
                    setSearch(_search);
                    submit(_search);
                }
            }, endAdornment: search && (React.createElement(material.IconButton, { sx: {
                    padding: 0,
                    opacity: 0.3
                }, onClick: function () {
                    setSearch('');
                ...
                React.createElement(iconsMaterial.Close, { fontSize: "small" }))), style: { borderRadius: 0, width: '450px', fontFamily: 'Roboto !important' } }),
        React.createElement(material.IconButton, { sx: {
                p: '8px',
                color: 'white',
...
var ReferencedCustomSearch = React.forwardRef(CustomSearch);
...
function CustomSelectFilter(_a) {
    ...
    var _c = React.useState(initialize !== null && initialize !== void 0 ? initialize : ''), state = _c[0], setState = _c[1];
    var _d = React.useState(initialize ? (_b = column.search.options.find(function (_a) {
        var value = _a.value;
        return initialize === value;
    })) === null || _b === void 0 ? void 0 : _b.text : ''), text = _d[0], setText = _d[1];
    var _e = React.useState(initialize !== null && initialize !== void 0 ? initialize : ''), filterState = _e[0], setFilterState = _e[1];
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement("div", { style: {
            ...
            React.createElement(material.Input, { sx: {
                    ':before': {
                        'all': 'unset'
                    },
                    ':after': {
        ...
        React.createElement("div", { className: 'container' },
            filterState && React.createElement(material.IconButton, { onClick: function (ev) {
                    ev.stopPropagation();
                    setFilterState('');
                    submit({
                ...
                React.createElement(iconsMaterial.Close, { style: { fill: '#0090D1', fontSize: '14px', opacity: 0.3 } })),
            React.createElement(material.IconButton, { onClick: handleClick, style: { borderRadius: 'unset' } },
                React.createElement(RiFilterLine, { style: { fill: '#0090D1' } }))),
        React.createElement(material.Menu, { sx: {
                width: 162,
            }, anchorEl: anchorEl, open: open, onClose: handleClose },
            React.createElement(material.ListItem, { sx: {
                    'div:first-of-type': {
                        minHeight: 'unset'
                    }
                } },
                React.createElement(VdsSelect, { value: state !== null && state !== void 0 ? state : '', onChange: function (ev) {
                    ...
                    return (React.createElement(material.MenuItem, { key: i, value: value !== null && value !== void 0 ? value : '' }, text !== null && text !== void 0 ? text : '---'));
                }))),
            React.createElement(material.ListItem, { style: { padding: '0 10px' } },
                React.createElement(material.IconButton, { size: "small", onClick: function () {
                        var _a;
                        handleClose();
                        setState(filterState);
                    ...
                    React.createElement(iconsMaterial.CloseOutlined, null)),
                React.createElement(material.IconButton, { size: "small", onClick: function () {
                        var _a;
                    ...
                    React.createElement(iconsMaterial.Check, null))))));
}
function CustomTextFilter(_a) {
    var _b;
    var config = _a.config, column = _a.column, submit = _a.submit, initialize = _a.initialize;
    var _c = React.useState(initialize !== null && initialize !== void 0 ? initialize : ''), state = _c[0], setState = _c[1];
    var _d = React.useState(initialize !== null && initialize !== void 0 ? initialize : ''), filterState = _d[0], setFilterState = _d[1];
    ...
    return (React.createElement("div", { style: {
        ...
        React.createElement("div", { className: 'container' },
            ...
            React.createElement(material.IconButton, { onClick: handleClick, style: { borderRadius: 'unset' } },
                React.createElement(RiFilterLine, { style: { fill: '#0090D1' } }))),
        React.createElement(material.Menu, { anchorEl: anchorEl, open: open, onClose: handleClose },
            React.createElement(material.ListItem, { sx: {
                    'div:first-of-type': {
                        minHeight: 'unset'
                    }
                } },
                React.createElement(VdsTextField, { value: state, onChange: function (ev) { return setState(ev.target.value); }, fullWidth: true, inputProps: {
...
function VdsTable1(props, ref) {
    ...
    var _q = React.useState(getSortingMap(columns, initialize)), sortingMap = _q[0], setSortingMap = _q[1];
    var _r = React.useState((_b = initialize === null || initialize === void 0 ? void 0 : initialize.page) !== null && _b !== void 0 ? _b : 1), page = _r[0], setPage = _r[1];
    var _s = React.useState((_e = (_c = initialize === null || initialize === void 0 ? void 0 : initialize.pageSize) !== null && _c !== void 0 ? _c : (_d = config === null || config === void 0 ? void 0 : config.pagination) === null || _d === void 0 ? void 0 : _d.defaultPageSize) !== null && _e !== void 0 ? _e : 10), pageSize = _s[0], setPageSize = _s[1];
    React.useEffect(function () {
        var _a;
    ...
    var VdsTablePagination = function (_a) {
        ...
        return (React.createElement("div", { style: { display: 'flex', alignItems: 'center', fontSize: '14px' } },
            React.createElement("p", null, ((_b = config === null || config === void 0 ? void 0 : config.localize) === null || _b === void 0 ? void 0 : _b.rowsForPage) || 'Righe per pagina:'),
            React.createElement(material.FormControl, { sx: {
                    'fieldset': {
                        border: 'unset'
                    }
                } },
                React.createElement(material.Select, { value: pageSize, style: { fontSize: '14px' }, onChange: handleChangeRowsPerPage }, rowsPerPageOptions.map(function (value, i) { return React.createElement(material.MenuItem, { value: value, key: "menuitem-" + i, style: { fontSize: '14px' } }, value); }))),
            (vdsTableArgs === null || vdsTableArgs === void 0 ? void 0 : vdsTableArgs.loader) && (React.createElement(React.Fragment, null, "-")),
            !(vdsTableArgs === null || vdsTableArgs === void 0 ? void 0 : vdsTableArgs.loader) && (React.createElement("p", null,
    ...
    var Row = function (_a) {
        ...
        var _b = React.useState(false), panel = _b[0], setPanel = _b[1];
        if (detailPanel) {
            return (React.createElement(React.Fragment, null,
                React.createElement(TableRow, { hover: true, sx: {
                        cursor: (events === null || events === void 0 ? void 0 : events.onRowClick) ? 'pointer' : 'text'
                    } }, columns.map(function (column, i) {
                    var _a, _b, _c, _d, _e, _f;
                    var width = column.width, style = column.style;
                    if (ColumnTypeGuard(column)) {
                        return (React.createElement(TableCell, { key: "row-" + rowindex + "-cell-" + i, sx: __assign$1({ cursor: 'pointer', width: width || 20, textAlign: 'center', paddingLeft: 0, paddingRight: 0 }, style) },
                            React.createElement(VdsTooltip, { arrow: true, title: column.tooltip },
                                React.createElement(material.IconButton, { onClick: function () {
                                        var _map = sortingMap === null || sortingMap === void 0 ? void 0 : sortingMap.sortingMap;
                                        var _sorting = { sort: null, order: null };
                                        for (var o in _map) {
                                            if (_map[o]) {
                        ...
                        return (React.createElement(TableCell, { key: "row-" + rowindex + "-cell-" + i, sx: __assign$1(__assign$1(__assign$1({}, (i === 0 ? {
                                border: panel ? '1px solid #0090D1' : 'inital',
                            } : {})), { cursor: (events === null || events === void 0 ? void 0 : events.onRowClick) ? 'pointer' : 'text', width: width }), style) }, (column === null || column === void 0 ? void 0 : column.tooltip) ? (React.createElement(VdsTooltip, { title: (column === null || column === void 0 ? void 0 : column.tooltip)(row), placement: "bottom", arrow: true },
                            React.createElement(ContainerWithTooltip, { style: __assign$1({}, (i === 0 ? {
                                    display: 'flex',
                                    alignItems: 'center',
                                } : {})) },
                                i === 0 && (React.createElement(material.IconButton, { size: "small", onClick: function () {
                                        setPanel(!panel);
                                    } }, panel ? React.createElement(BsFillCaretRightFill, null) : React.createElement(BsCaretDownFill, null))),
                                React.createElement("div", { onClick: function () {
                                    ...
                                    }, style: style }, (((_a = column) === null || _a === void 0 ? void 0 : _a.field) && byString(row, (_b = column) === null || _b === void 0 ? void 0 : _b.field)) || (((_c = column) === null || _c === void 0 ? void 0 : _c.render) && column.render(row)))))) : (React.createElement("div", { style: __assign$1({}, (i === 0 ? {
                                display: 'flex',
                                alignItems: 'center',
                            } : {})) },
                            i === 0 && (React.createElement(material.IconButton, { size: "small", onClick: function () {
                ...
                panel && (React.createElement(TableRow, { key: "row-" + rowindex + "-cell-detail", style: {
                        cursor: 'pointer'
                    } },
                    React.createElement(TableCell, { colSpan: columns.length, style: {
                            cursor: 'pointer'
                        } }, detailPanel(vdsTableArgs.data))))));
        }
        return (React.createElement(TableRow, { sx: ((config === null || config === void 0 ? void 0 : config.onRowSelected) && (config === null || config === void 0 ? void 0 : config.onRowSelected(row))) ? {
                'td:first-of-type': {
            ...
            var _a, _b, _c, _d, _e, _f;
            if (ColumnTypeGuard(column)) {
                return (React.createElement(TableCell, { key: "row-" + rowindex + "-cell-" + i, style: __assign$1({ wordBreak: 'break-all' }, column.style) },
                    React.createElement(VdsTooltip, { arrow: true, title: column.tooltip },
                        React.createElement(material.IconButton, { onClick: function () { return column.onClick(row); }, size: "small" }, column.icon))));
            }
            else {
                return (React.createElement(TableCell, { key: "row-" + rowindex + "-cell-" + i, style: __assign$1({ cursor: (events === null || events === void 0 ? void 0 : events.onRowClick) ? 'pointer' : 'text', wordBreak: 'break-all' }, column.style), onClick: function () {
                        if (events === null || events === void 0 ? void 0 : events.onRowClick) {
                            var _map = sortingMap === null || sortingMap === void 0 ? void 0 : sortingMap.sortingMap;
                            var _sorting = { sort: null, order: null };
                            for (var o in _map) {
    ...
    function ConditionalSorting(_a) {
        ...
        if (!ColumnTypeGuard(column) && (sortingMap === null || sortingMap === void 0 ? void 0 : sortingMap.sortingMap) && ((_b = column.sorting) === null || _b === void 0 ? void 0 : _b.field)) {
            ...
            if (sortState === 'Asc')
                return (React.createElement(material.IconButton, { size: "small", style: { fontSize: '16px' }, onClick: function () {
                        var _a;
                    ...
                    React.createElement(FaSortDown, { style: { fill: '#005075' } })));
            if (sortState === 'Desc')
                return (React.createElement(material.IconButton, { size: "small", style: { fontSize: '16px' }, onClick: function () {
                        var _a;
                    ...
                    React.createElement(FaSortUp, { style: { fill: '#005075' } })));
            return (React.createElement(material.IconButton, { size: "small", style: { fontSize: '16px' }, onClick: function () {
                    var _a;
                    var _sortingMap = __assign$1(__assign$1({}, sortingMap.osortingMap), (_a = {}, _a[column.sorting.field] = 'Asc', _a));
                    setSortingMap(__assign$1(__assign$1({}, sortingMap), { sortingMap: _sortingMap }));
                ...
                React.createElement(FaSort, { style: { fill: '#005075' } })));
        }
        return null;
    }
    return (React.createElement("div", { style: { height: '100%', display: 'flex', flexDirection: 'column' } },
        ((_f = config === null || config === void 0 ? void 0 : config.search) === null || _f === void 0 ? void 0 : _f.useSearch) && (React.createElement("div", null,
            React.createElement(ReferencedCustomSearch, { searchConfig: config === null || config === void 0 ? void 0 : config.search, initialize: initialize, ref: searchRef, submit: function (search) {
                    var _a, _b, _c;
                    var _page = 1;
        ...
        ((actions === null || actions === void 0 ? void 0 : actions.length) || ((_g = config === null || config === void 0 ? void 0 : config.pagination) === null || _g === void 0 ? void 0 : _g.usePagination)) && (React.createElement("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'end', minHeight: '56px' } },
            (actions === null || actions === void 0 ? void 0 : actions.length) && (React.createElement(material.Stack, { direction: "row", spacing: 2, sx: { flexGrow: 1 } }, actions.map(function (action, j) {
                return action && (React.createElement(VdsTooltip, { arrow: true, title: action.tooltip, key: "action-" + j },
                    React.createElement(material.IconButton, { disabled: ((action === null || action === void 0 ? void 0 : action.disableIfEmpty) && !vdsTableArgs.data.length) || (action === null || action === void 0 ? void 0 : action.disabled), onClick: function (ev) {
                            var _map = sortingMap === null || sortingMap === void 0 ? void 0 : sortingMap.sortingMap;
                            var _sorting = { sort: null, order: null };
                            for (var o in _map) {
                                if (_map[o]) {
            ...
            ((_h = config === null || config === void 0 ? void 0 : config.pagination) === null || _h === void 0 ? void 0 : _h.usePagination) && (React.createElement(VdsTablePagination, { rowsPerPageOptions: (_k = (_j = config === null || config === void 0 ? void 0 : config.pagination) === null || _j === void 0 ? void 0 : _j.rowsPerPageOptions) !== null && _k !== void 0 ? _k : [5, 10, 25] })))),
        React.createElement(TableContainer, { sx: { height: config === null || config === void 0 ? void 0 : config.height, maxHeight: (config === null || config === void 0 ? void 0 : config.maxHeight) || 440, overflowX: 'hidden' } },
            React.createElement(Table, { stickyHeader: true, size: "small", style: { tableLayout: 'fixed' } },
                React.createElement(TableHead, null,
                    React.createElement(TableRow, null, columns.filter(function (_a) {
                        var title = _a.title;
                        return title;
                    }).length && (columns.map(function (column, ci) { return (React.createElement(TableCell, { key: "th-cell-" + ci, sx: __assign$1({ fontSize: "14px", color: "#005075", lineHeight: "16px", fontFamily: "Roboto", fontWeight: 500, textAlign: "left" }, column.thStyle) },
                        React.createElement("div", { style: __assign$1({}, (column.sorting && {
                                display: 'flex',
                                alignItems: 'center'
                            })) }, column === null || column === void 0 ? void 0 :
                            column.title,
                            React.createElement(ConditionalSorting, { column: column })))); }))),
                    !!columns.filter(function (props) { return props === null || props === void 0 ? void 0 : props.search; }).length && (React.createElement(TableRow, null, columns.map(function (column, ci) {
                        var _a, _b, _c, _d, _e, _f;
                        return (React.createElement(TableCell, { key: "th-search-cell-" + ci, sx: {
                            ...
                            (React.createElement(CustomTextFilter, { config: config, column: column, submit: function (_a) {
                                    var _b;
                                    var _c, _d, _e;
                            ...
                            (React.createElement(CustomSelectFilter, { config: config, column: column, submit: function (_a) {
                                    var _b, _c;
                                    var _d, _e, _f;
                                    var field = _a.field, value = _a.value;
                                    var _page = 1;
                ...
                React.createElement(TableBody, { style: { cursor: 'pointer' } },
                    (vdsTableArgs === null || vdsTableArgs === void 0 ? void 0 : vdsTableArgs.loader) && (React.createElement(TableRow, null,
                        React.createElement(TableCell, { colSpan: columns.length, sx: { textAlign: 'center', height: (42 * pageSize) } },
                            React.createElement(material.CircularProgress, null)))),
                    !(vdsTableArgs === null || vdsTableArgs === void 0 ? void 0 : vdsTableArgs.loader) && !vdsTableArgs.data.length && (React.createElement(TableRow, null,
                        React.createElement(TableCell, { colSpan: columns.length, sx: { textAlign: 'center', height: (42 * pageSize) } },
                            React.createElement("div", null, ((_l = config === null || config === void 0 ? void 0 : config.localize) === null || _l === void 0 ? void 0 : _l.noData) || 'No Data')))),
                    !(vdsTableArgs === null || vdsTableArgs === void 0 ? void 0 : vdsTableArgs.loader) && !!vdsTableArgs.data.length && vdsTableArgs.data.map(function (row, ri) {
                        return (React.createElement(Row, { key: "row-" + ri, row: row, rowindex: ri }));
                    })))),
        React.createElement("div", { style: { display: 'flex', justifyContent: 'end', alignItems: 'center', marginTop: '10px' } },
            (vdsTableArgs === null || vdsTableArgs === void 0 ? void 0 : vdsTableArgs.loader) && ((_m = config === null || config === void 0 ? void 0 : config.pagination) === null || _m === void 0 ? void 0 : _m.usePagination) && (React.createElement(React.Fragment, null, "-")),
            !(vdsTableArgs === null || vdsTableArgs === void 0 ? void 0 : vdsTableArgs.loader) && ((_o = config === null || config === void 0 ? void 0 : config.pagination) === null || _o === void 0 ? void 0 : _o.usePagination) && (React.createElement(Pagination, { count: pageSize > 0 ? Math.ceil(totalCount / pageSize) : 0, page: page, shape: "rounded", onChange: handlePageChange, sx: {
                    fontSize: '14px',
...
var VdsTable = React.forwardRef(VdsTable1);

var StyledDatepickerContainer = material.styled('div')(function (_a) {
...
var StyledInfosContainer = material.styled('div')({
    'marginBottom': '12px',
    'display': 'flex',
    'flexDirection': 'column'
});
var StyledHelperTextContainer = material.styled('span')(function (_a) {
...
var StyledLabelContainer = material.styled('span')(function (_a) {
...
var VdsDatepicker = function (props) {
    ...
    var FromDateInput = React__default.forwardRef(function (_a, ref) {
        ...
        return (React__default.createElement(VdsTextField, { ref: ref, size: "small", value: value, error: error, errorText: errorText, disabled: disabled, endAdornment: (React__default.createElement(React__default.Fragment, null,
                !disabled && value && React__default.createElement(material.IconButton, { style: { padding: '0px !important' }, size: "small", onClick: function (ev) {
                        ev.stopPropagation();
                        clear(null);
                    } },
                    React__default.createElement(iconsMaterial.Cancel, { style: { fontSize: '16px', padding: '0px !important' } })),
                React__default.createElement(iconsMaterial.EventNote, { style: { fontSize: '16px', padding: '0px !important' } }))), placeholder: "---", fullWidth: true, onClick: onClick }));
    });
...
var StyledChipContainer = material.styled('div')(function () { return ({
    fontSize: "12px",
    color: "#005075",
    letterSpacing: "0",
    lineHeight: "24px",
...
var StyledIconButton$1 = material.styled(material.IconButton)(function () { return ({
    padding: 0,
...
var VdsChip = function (_a) {
    ...
    return (React.createElement(StyledChipContainer, { style: { paddingRight: onDelete ? 0 : '16px' } },
        htmlToText$1(label),
        onDelete && (React.createElement(StyledIconButton$1, { disabled: disabled, onClick: onDelete },
            React.createElement(IoIosClose, null)))));
};
...
var StyledTextFieldContainer = material.styled('div')(function () { return ({
    'display': 'flex',
    'minHeight': '96px',
    'fontFamily': '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen-Sans, Ubuntu, Cantarell, "Helvetica Neue", sans-serif',
    'flexDirection': 'column',
...
var StyledInfosContainer$1 = material.styled('div')({
    'marginBottom': '12px',
    'display': 'flex',
    'flexDirection': 'column'
});
var StyledHelperTextContainer$1 = material.styled('span')(function (_a) {
    var disabled = _a.disabled;
    return ({
        'fontSize': "12px",
        'color': disabled ? '#C1C1C4' : "#9DA6AD",
...
var StyledLabelContainer$1 = material.styled('span')(function (_a) {
    var disabled = _a.disabled, readOnly = _a.readOnly;
    return ({
        'fontSize': "14px",
        'color': readOnly ? "black" : disabled ? "#9DA6AD" : "#152935",
...
var StyledErrorContainer = material.styled('span')({
    'fontSize': "12px",
    'color': "#D82829",
    'lineHeight': "18px",
    'fontFamily': "Roboto !important",
...
var StyledAutocompleteTextField = material.styled(material.TextField)(function (_a) {
    var disabled = _a.disabled, readOnly = _a.readOnly, error = _a.error;
    return ({
        'input': {
            minHeight: '28px',
...
var VdsAutocomplete = function (props) {
    ...
    return (React.createElement(StyledTextFieldContainer, null,
        (label || helperText) && (React.createElement(StyledInfosContainer$1, null,
            label && (React.createElement(StyledLabelContainer$1, null, label)),
            helperText && (React.createElement(StyledHelperTextContainer$1, { disabled: disabled }, helperText)))),
        React.createElement(material.Autocomplete, { multiple: true, filterSelectedOptions: true, options: options, getOptionLabel: getOptionLabel, value: value, onChange: onChange, disabled: disabled, renderTags: renderTags, noOptionsText: noOptionsText, ListboxProps: {
                style: {
                    maxHeight: 224
                }
            }, renderInput: function (params) { return (React.createElement(StyledAutocompleteTextField, __assign$1({}, params, { error: error, variant: "filled" }))); } }),
        error && (React.createElement(StyledErrorContainer, null,
            React.createElement(AiFillMinusCircle, { style: { fill: '#D82829', fontSize: '13px', padding: '0 5px' } }),
            " ",
            errorText))));
};

var VdsButton = material.styled(material.Button)(function (_a) {
...
const OutlinedInput = /*#__PURE__*/React.forwardRef(function OutlinedInput(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime_1(InputBase, _extends({
    ...
    renderSuffix: state => /*#__PURE__*/jsxRuntime_1(NotchedOutlineRoot$1, {
      ...
      label: label != null && label !== '' && fcs.required ? _React$Fragment || (_React$Fragment = /*#__PURE__*/jsxRuntime_2(React.Fragment, {
        children: [label, "\xA0", '*']
      })) : label,
...
var StyledTextFieldContainer$1 = material.styled('div')(function () { return ({
    display: 'flex',
    minHeight: '96px',
    fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen-Sans, Ubuntu, Cantarell, "Helvetica Neue", sans-serif',
    flexDirection: 'column',
...
var StyledInfosContainer$2 = material.styled('div')({
    marginBottom: '12px',
    display: 'flex',
    flexDirection: 'column'
});
var StyledErrorContainer$1 = material.styled('span')({
    fontSize: "12px",
    color: "#D82829",
    lineHeight: "18px",
    fontFamily: "Roboto",
...
var StyledLabelContainer$2 = material.styled('span')(function (_a) {
    var disabled = _a.disabled, readOnly = _a.readOnly;
    return ({
        fontSize: "14px",
        color: readOnly ? "black" : disabled ? "#9DA6AD" : "#152935",
...
var StyledSelect = material.styled(Select, { shouldForwardProp: function (props) { return props; } })(function (_a) {
...
var VdsSelect = function (props) {
    ...
    return (React.createElement(StyledTextFieldContainer$1, null,
        label && React.createElement(StyledInfosContainer$2, null,
            React.createElement(StyledLabelContainer$2, null, label)),
        React.createElement(FormControl, { sx: { minWidth: 250 }, size: "small" },
            React.createElement(StyledSelect, __assign$1({}, MuiSelectProps), children)),
        props.error && (React.createElement(StyledErrorContainer$1, null,
            React.createElement(AiFillMinusCircle, { style: { fill: '#D82829', fontSize: '13px', padding: '0 5px' } }),
            " ",
            props.errorText))));
};
...
var VdsSwitch = material.styled(Switch)(function (_a) {
...
var StyledTextFieldContainer$2 = material.styled('div')(function () { return ({
    display: 'flex',
    minHeight: '96px',
    fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen-Sans, Ubuntu, Cantarell, "Helvetica Neue", sans-serif',
    flexDirection: 'column',
...
var StyledInfosContainer$3 = material.styled('div')({
    marginBottom: '12px',
    display: 'flex',
    flexDirection: 'column'
});
var StyledHelperTextContainer$2 = material.styled('span')(function (_a) {
    var disabled = _a.disabled;
    return ({
        fontSize: "12px",
        color: disabled ? '#C1C1C4' : "#9DA6AD",
...
var StyledLabelContainer$3 = material.styled('span')(function (_a) {
    var disabled = _a.disabled, readOnly = _a.readOnly;
    return ({
        fontSize: "14px",
        color: readOnly ? "black" : disabled ? "#9DA6AD" : "#152935",
...
var StyledInput$1 = material.styled(Input, { shouldForwardProp: function (props) { return props; } })(function (_a) {
    var disabled = _a.disabled, readOnly = _a.readOnly, error = _a.error;
    return ({
        border: disabled ? '1px solid #C1C1C4' : readOnly ? '1px solid #C1C1C4' : error ? '1px solid #D82829' : '1px solid #C9D9E8',
        backgroundColor: (disabled || readOnly) ? '#FAFBFD' : '#F2F5F8',
...
var StyledErrorContainer$2 = material.styled('span')({
    fontSize: "12px",
    color: "#D82829",
    lineHeight: "18px",
    fontWeight: 400,
...
var VdsTextField = function (props) {
    return (React.createElement(StyledTextFieldContainer$2, null,
        (props.label || props.helperText) && (React.createElement(StyledInfosContainer$3, null,
            props.label && (React.createElement(StyledLabelContainer$3, null, props.label)),
            props.helperText && (React.createElement(StyledHelperTextContainer$2, { disabled: props === null || props === void 0 ? void 0 : props.disabled }, props.helperText)))),
        React.createElement(StyledInput$1, { value: htmlToText$1(props.value), placeholder: props.placeholder, disabled: props.disabled, readOnly: props.readOnly, error: props.error, onChange: props.onChange, onKeyPress: props.onKeyPress }),
        props.error && (React.createElement(StyledErrorContainer$2, null,
            React.createElement(AiFillMinusCircle, { style: { fill: '#D82829', fontSize: '13px', padding: '0 5px' } }),
            " ",
            props.errorText))));
};

exports.StyledAutocompleteTextField = StyledAutocompleteTextField;
exports.VdsAlert = VdsAlert;
exports.VdsAutocomplete = VdsAutocomplete;
exports.VdsBreadcrumb = VdsBreadcrumb;
exports.VdsButton = VdsButton;
exports.VdsChip = VdsChip;
exports.VdsDatepicker = VdsDatepicker;
exports.VdsDialog = VdsDialog;
exports.VdsDrawer = VdsDrawer;
exports.VdsPageTitle = VdsPageTitle;
exports.VdsSelect = VdsSelect;
exports.VdsSwitch = VdsSwitch;
exports.VdsTable = VdsTable;
exports.VdsTextField = VdsTextField;
exports.VdsTooltip = VdsTooltip;
