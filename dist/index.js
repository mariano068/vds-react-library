...
var VdsChip = function (_a) {
    ...
    return (React.createElement("div", { style: {
        ...
        htmlToText$1(label),
        onDelete && (React.createElement(material.IconButton, { disabled: disabled, sx: {
                padding: 0,
...
var VdsTextField = function (props) {
    ...
    return (React.createElement(StyledTextFieldContainer$2, null,
        (label || helperText) && (React.createElement(StyledInfosContainer$3, null,
            label && (React.createElement(StyledLabelContainer$3, null, label)),
            helperText && (React.createElement(StyledHelperTextContainer$2, { disabled: props === null || props === void 0 ? void 0 : props.disabled }, helperText)))),
        React.createElement(StyledInput$1, { value: htmlToText$2(value), placeholder: placeholder, disabled: disabled, readOnly: readOnly, error: error, onChange: onChange, onKeyPress: onKeyPress }),
        error && (React.createElement(StyledErrorContainer$2, null,
            React.createElement(AiFillMinusCircle, { style: { fill: '#D82829', fontSize: '13px', padding: '0 5px' } }),
            " ",
            errorText))));
};
